...
export const createStyles = colors => StyleSheet.create({
    ...
    favoritesSection: { marginBottom: 20, gap: 10 },
    favoritesHeading: { flexDirection: 'row', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
    favoritesLabel: { color: colors.textSecondary, fontSize: 9, fontWeight: '600', letterSpacing: 1 },
    favoritesHint: { color: colors.muted, fontSize: 10, marginLeft: 'auto' },
    favoriteChips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    favoriteChip: { minHeight: 44, paddingHorizontal: 17, borderRadius: 22, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' },
    favoriteChipText: { color: colors.text, fontSize: 12, fontWeight: '600' },
    favoriteError: { backgroundColor: colors.errorBackground, borderRadius: 12, padding: 14, marginBottom: 14 },
    modeSelector: { flexDirection: 'row', padding: 4, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.cardBackground, borderRadius: 18, marginBottom: 16 },
    modeButton: { flex: 1, minHeight: 46, paddingVertical: 8, paddingHorizontal: 6, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, borderRadius: 13 },
    modeButtonActive: { backgroundColor: colors.inputBackground },
    modeText: { color: colors.muted, fontSize: 12, fontWeight: '600', flexShrink: 1 },
    multiHint: { marginTop: 23, paddingTop: 18, borderTopWidth: 1, borderTopColor: colors.border, flexDirection: 'row', alignItems: 'center', gap: 10 },
    multiHintText: { flex: 1, color: colors.textSecondary, fontSize: 12, lineHeight: 18 },
    ...
    offlinePanel: { marginTop: 16, borderWidth: 1, borderColor: colors.border, borderRadius: 18, padding: 15 },
    offlineHeading: { flexDirection: 'row', alignItems: 'center', gap: 11 },
    savedDate: { color: colors.muted, fontSize: 10, lineHeight: 16, marginTop: 12 },
    cacheNotice: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 14, backgroundColor: colors.accentSoft, borderRadius: 14, marginTop: 12 },
    cacheNoticeText: { flex: 1, fontSize: 12, lineHeight: 18, color: colors.primary },
